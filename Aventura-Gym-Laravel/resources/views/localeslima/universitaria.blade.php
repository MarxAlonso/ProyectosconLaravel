<br>
<!-- Nuevo apartado del local Universitaria 2751 -->
<hr class="lineal-local2">
<br>
<div class="container galeria local-santana">
    <h1 class="locales">Aventura Gym Local Universitaria 2751</h1>
    <div class="image-container">
        <div class="image"><img src="{{asset('images/salon-Universitaria2751.webp')}}" alt="Local Universitaria 2751"></div>
        <div class="image"><img src="{{asset('images/entreno-universitaria2751.webp')}}" alt="Local Universitaria 2751"></div>
        <div class="image"><img src="{{asset('images/local-Universitaria2751.webp')}}" alt="Local Universitaria 2751"></div>
    </div>

    <div class="popup-image">
        <span class="close">&times;</span>
        <img src="{{asset('images/salon-Universitaria2751.webp')}}" alt="Local San Martin de Porres">
    </div>
</div>
<br>
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-8 text-center"> <!-- Ajusta el tamaño de la columna según tus necesidades -->
            <a href="https://g.co/kgs/trqVZPa" target="_blank" class="reserva-aqui">VER UBICACION</a>
        </div>
    </div>
</div>
<br>
